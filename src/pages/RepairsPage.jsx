...
export default function RepairsPage() {
  ...
  return (
    <>
      ...
      <section className="bg-white py-24 sm:py-32"><div className="mx-auto max-w-[1240px] px-5 sm:px-8"><Reveal className="max-w-3xl"><h2 className="section-title">Quality Parts. Honest Warranties.</h2><p className="section-copy">We believe in transparency. You will always know whether we are installing an Original Equipment Manufacturer (OEM) part or a high-quality aftermarket alternative.</p></Reveal><div className="mt-14 grid gap-5 lg:grid-cols-2"><Reveal className="rounded-[16px] bg-[#f4f7fb] p-8 sm:p-10"><h3 className="text-2xl font-[760] tracking-[-0.03em] text-[#1857d8]">OEM vs. Aftermarket</h3><p className="mt-4 leading-7 text-[#5a6780]">We offer OEM components for those who want original specifications, and tested aftermarket parts for cost-effective repairs. We explain the difference in performance and price before you choose.</p></Reveal><Reveal className="rounded-[16px] bg-[#f4f7fb] p-8 sm:p-10"><h3 className="text-2xl font-[760] tracking-[-0.03em] text-[#1857d8]">Our Repair Guarantee</h3><p className="mt-4 leading-7 text-[#5a6780]">Every repair is backed by a standard warranty covering the installed parts and labor. If the replaced component fails due to a defect, we will make it right at no extra cost.</p></Reveal></div></div></section>
      <RepairFaq />
